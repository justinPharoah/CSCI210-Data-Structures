...
public class ObjectBinaryTree implements ObjectBinaryTreeInterface {
    ...
    /**
     * ObjectBinaryTree, Default Constructor
     */
    ObjectBinaryTree() {
        root = null;
    }
    ...
    /**
     * Gets and returns the root of th ObjectBinaryTree
     *
     * @return ObjectTreeNode root of the tree
     */
     ...
     *
     * @param parent parent of left child to be set
    ...
    /**
     * Sets the right child given a parent
     *
     * @param parent parent of right child to be set
    ...
    /**
     * Inserts an Object into the binary search tree but also handles cases of duplicate Objects
     *
     * @param o Object to be inserted
     * @return void
     */
    ...
    /**
     * Searches a binary search tree for an Object
     *
     * @param o Object to be searched for
     * @return Node reference to the Object o
     */
     ...
     *
     * @param tree ObjectTreeNode to be
     * @return void
     */
    ...
    /**
     * Deletes an Object o from a binary tree
     *
